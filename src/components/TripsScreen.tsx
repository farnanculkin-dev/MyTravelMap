  ...
  return (
    <main className="trips-screen">
      <div className="trips-header">
        ...
        <button className="primary-btn trips-add-btn" type="button" onClick={() => setShowCreate((value) => !value)}>{showCreate ? 'Cancel' : '+ Add trip'}</button>
      </div>
